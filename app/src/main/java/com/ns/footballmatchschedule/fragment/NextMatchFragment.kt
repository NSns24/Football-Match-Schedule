...
import com.ns.footballmatchschedule.adapter.MainNextMatchAdapter
...
class NextMatchFragment : Fragment(), MainView {
    ...
    private lateinit var mainAdapter: MainNextMatchAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mainAdapter = MainNextMatchAdapter(matches) {
        ...
        presenter.getNextMatches(LEAGUE_ID)

        activity?.title = "Next Matches"
